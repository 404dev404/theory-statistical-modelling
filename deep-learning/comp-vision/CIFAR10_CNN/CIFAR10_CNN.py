...
'''
Train a simple deep CNN on CIFAR10 small images dataset using Keras
...
tensorboard = keras.callbacks.TensorBoard(log_dir='./logs', histogram_freq=0, batch_size=32, write_graph=True, 
